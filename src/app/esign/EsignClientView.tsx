...
import type { EsignScrapedData, EsignCertificate } from '@/lib/scraper';

interface EsignClientViewProps {
  scrapedData: EsignScrapedData;
}

export default function EsignClientView({ scrapedData }: EsignClientViewProps) {
    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 flex flex-col gap-10">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border/40 bg-card/40 p-8 sm:p-10 flex flex-col gap-4 shadow-sm">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-foreground max-w-2xl leading-none">
          ESign <span className="text-argent">Signer</span> Hub
        </h1>
        <p className="text-muted-foreground text-sm sm:text-base max-w-2xl leading-relaxed">
          Sign and install customized IPA applications directly from your iPhone or iPad using enterprise certificate credentials. No computer required, fully self-hosted.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border/30 bg-card p-6 flex flex-col justify-between h-56 hover:border-argent/40 transition-all duration-300">
            ...
            <div className="mt-4 flex-1">
              ...
              <p className="text-muted-foreground text-xs mt-2 line-clamp-2">
                Modified ESign IPA package with debug logs disabled for faster app installations.
              </p>
            </div>
            <a 
              href={scrapedData.noLogsIpa}
          ...
          {/* Tool 2: Anti-Revoke DNS Profile */}
          <div className="group relative overflow-hidden rounded-3xl border border-border/30 bg-card p-6 flex flex-col justify-between h-56 hover:border-argent/40 transition-all duration-300">
            <div className="flex justify-between items-start">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-quartz/20 border border-border/20 text-argent">
            ...
            <div className="mt-4 flex-1">
              ...
              <p className="text-muted-foreground text-xs mt-2 line-clamp-2">
                Configuration profile to block Apple's OCSP verification servers and protect apps from revokes.
              </p>
            </div>
            <a 
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-border/30 bg-card p-6 flex flex-col justify-between h-56 hover:border-argent/40 transition-all duration-300">
            ...
            <div className="mt-4 flex-1">
              ...
              <p className="text-muted-foreground text-xs mt-2 line-clamp-2">
                Bundled ZIP containing all corporate P12 keys and mobileprovision credential pairings.
              </p>
            </div>
            <a 
      ...
      <section className="rounded-3xl border border-border/30 bg-card/20 p-6 flex flex-col gap-6">
        <div className="flex items-center gap-2 border-b border-border/10 pb-4">
          ...
          <h3 className="font-bold uppercase tracking-wider text-sm text-foreground">
            ESign Installation Tutorial Guide
          </h3>
        </div>
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                Install the Config Profile (DNS tab) to block Apple's OCSP servers first.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1">
              <h4 className="text-xs font-bold text-foreground">Direct Install App</h4>
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                Click "Direct Install" on one of the active signing certificate cards below.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1">
              <h4 className="text-xs font-bold text-foreground">Trust Developer</h4>
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                Go to iOS Settings &gt; General &gt; VPN &amp; Device Management to Trust Certificate.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-1">
              <h4 className="text-xs font-bold text-foreground">Import Credentials</h4>
              <p className="text-[11px] text-muted-foreground leading-relaxed">
                Download the ZIP bundle. Import the matching P12 and Provision file into ESign.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/40 pb-6">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-muted-foreground">
              Directly install ESign with any active certificate credential listed below.
            </p>
          </div>
          <div className="relative w-full md:max-w-md">
            ...
            <input
              type="text"
              placeholder="Search certificates, bundle IDs..."
              value={searchQuery}
